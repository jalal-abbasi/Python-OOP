    ...
    def start_game(self):
        ...
        while True:
            ...
            while True:
                ...
                self.show_updated_board()

                print("\n")
                self.get_player_choice(self._computer)
                self.show_updated_board()
                if self.check_game_over(self._player) or self.check_game_over(self._computer):
                    break
            play_again = input("Do you want to play one more time? Y/ N ").capitalize()
            if play_again == 'Y':
                continue
            elif play_again == 'N':
                print("Hope to see you soon MotherFucker")
                break
            else:
                print("I didn't get a yes or a no, I assume is as a No")
                print("Hope to see you soon MotherFucker")
                break
