...
class HospitalVendingMachine(VendingMachine):
    # Complete the class
    snack_prices = {"candy": 1.99, "soda": 1.49, "chips": 2.99, "cookies": 3.49}
    ...
    def print_days_until_maintenance(self):
        print(f"the number of days remaining for the maintenance is {self.days_until_maintenance}")


class SchoolVendingMachine(VendingMachine):
    # Complete the class
    SNACK_PRICES = {"candy": 2.50, "soda": 2.00, "chips": 3.50, "cookies": 4.00}
    STUDENT_DEBT = {"Jalal": 0, "Ben": 2.00, "Anna": 0.5, "Elnaz": 1.3, "Hamid": 2.5, "Farshad": 0.25, "Ahmad": 7},
    ...
    def print_student_debt(self, name):
        print(f"the debt of {name} is {self.STUDENT_DEBT[name]}")
